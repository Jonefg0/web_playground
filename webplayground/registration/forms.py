...
class ProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'bio': forms.Textarea(attrs={'class':'form-control mt-3', 'rows':3, 'placeholder':'Cuentanos sobre tí'}),
            'link': forms.URLInput(attrs={'class':'form-control mt-3', 'placeholder':'Ingresa tu url'})
        }
